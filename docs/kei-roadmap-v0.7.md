...
|---|---|---|---|---|
| **M37** | `uses Async` エフェクト + async 関数コア(check + emit) | high | ✅ 実装済み | kei_check / kei_emit / kei_syntax |
| **M38** | async 境界と検証整合(extern / 契約 / pbt / e2e / 取説) | high | ✅ 実装済み | kei_check / kei_emit / kei_cli / tests/e2e / spec / skill |
